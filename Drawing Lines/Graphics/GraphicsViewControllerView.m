...
//  // Drawing code
//  
//  /* Set the color using which we want
//   to draw the line */
...
//                          200.0f);
//  
//  /* Use the context's current color to draw
//   the line */
...
- (void) drawRooftopAtTopPointof:(CGPoint)paramTopPoint
  ...
  /* Draw the text in the rooftop using
   a black color */
  [[UIColor blackColor] set];
  /* Now draw the text */
  [paramText 
   drawAtPoint:CGPointMake(paramTopPoint.x - 40.0f,
